...
public class PerformanceAnalyzerCollectorsSettingHandlerTests {
    private PerformanceAnalyzerCollectorsSettingHandler handler;
    ...
    public void testOnSettingUpdate() {
        ...
        verify(controller, never()).updateCollectorsSetting(anyInt());

        newSettingValue = 1;
        handler.onSettingUpdate(newSettingValue);
        verify(controller).updateCollectorsSetting(newSettingValue);
    }
}
